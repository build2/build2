...
echo on
%cxx% -I%libbutl% -I. -DBUILD2_BOOTSTRAP -DBUILD2_HOST_TRIPLET=\"x86_64-w64-mingw32\" -D_WIN32_WINNT=0x0601 -DLIBBUTL_MINGW_STDTHREAD %ops% -o b\b-boot.exe %r% -pthread -limagehlp
@echo off
