...
namespace build2
{
  ...
  public:
    ...
    // If json5 is true, then use JSON5 syntax during serialization. If the
    // expected type is specfied, then fail if it does not match the value's.
  ...
  public:
    ...
    void
    serialize (json_buffer_serializer&, bool json5) const;
  };
