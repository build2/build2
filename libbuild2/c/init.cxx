  ...
  namespace c
  {
                  ...
                  module_init_extra&)
    {
      ...
      //
      {
        ...
        vp.insert_alias (*mod->c_predefs_poptions, "c.predefs.poptions");
        vp.insert_alias (*mod->c_predefs_default, "c.predefs.default");
        vp.insert_alias (*mod->c_predefs_macros, "c.predefs.macros");
      }
